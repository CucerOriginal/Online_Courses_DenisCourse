    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Student>().HasData(
                new Student { Id = 1, SecondName = "Куликов", FirstName = "Николай", MiddleName = "Алиевич", Address = "г.Казань, Домодедовская, 58", PhoneNumber = "89550367416", Birthday = new DateOnly(2000, 01, 21), CoursesListId = 1},
                new Student { Id = 2, SecondName = "Кузнецов", FirstName = "Николай", MiddleName = "Марсельевич", Address = "г.Казань, Ленина, 53", PhoneNumber = "89303347156", Birthday = new DateOnly(1999, 10, 23), CoursesListId = 2 },
                new Student { Id = 3, SecondName = "Петров", FirstName = "Ярослав", MiddleName = "Львович", Address = "г.Казань, Ленина, 23", PhoneNumber = "89303767156", Birthday = new DateOnly(1996, 11, 11), CoursesListId = 3 });
